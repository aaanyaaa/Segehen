...
# a 24hr clock.                                               
data_columns = [1, 3, 4, 5, 7, 8, 9, 11, 12, 13, 15, 16, 18, 20, 21]
...
def write_data(data_row, fieldnames):
    with open(output_file_name, 'a') as csv_file:
        ...
        hourlywriter.writerow({
            ...
            'SNOW DEPTH (mm)': data_row[15],
            'TOTAL PRECIP (mm)': data_row[16],
        })
    ...
    for year in range(start_year, end_year + 1):
        ...
        for month in range(1, 13):
            ...
            for day in range(1, 32):
                if year == 2001 and month <= 8:
                    pass
                elif year == 2002 and month >= 10:
                    pass
                else:
                    try:
