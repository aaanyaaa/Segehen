...
class Hour(peewee.Model):
    date_time = peewee.DateTimeField()
    solar_rad = peewee.CharField(
        verbose_name="TOTAL SOLAR RAD (K W-hr/m^2)",  max_length=225)
    wind_ave = peewee.CharField(
        verbose_name="AVE WIND SPEED (m/s)",  max_length=225)
    wind_dir = peewee.CharField(
        verbose_name="V. WIND DIR (Deg)",  max_length=225)
    wind_max = peewee.CharField(
        verbose_name="MAX WIND SPEED (m/s)",  max_length=225)
    temp_ave = peewee.CharField(
        verbose_name="AIR TEMP AVE (Deg C)",  max_length=225)
    temp_max = peewee.CharField(
        verbose_name="AIR TEMP MAX (Deg C)",  max_length=225)
    temp_min = peewee.CharField(
        verbose_name="AIR TEMP MIN (Deg C)",  max_length=225)
    soil_tave = peewee.CharField(
        verbose_name="SOIL TEMP AVE (Deg C)",  max_length=225)
    soil_tmax = peewee.CharField(
        verbose_name="SOIL TEMP MAX (Deg C)",  max_length=225)
    soil_tmin = peewee.CharField(
        verbose_name="SOIL TEMP MIN (Deg C)",  max_length=225)
    rh_ave = peewee.CharField(
        verbose_name="RELATIVE HUMIDITY AVE (%)",  max_length=225)
    rh_max = peewee.CharField(
        verbose_name="RELATIVE HUMIDITY MAX (%)",  max_length=225)
    rh_min = peewee.CharField(
        verbose_name="RELATIVE HUMIDITY MIN (%)",  max_length=225)
    dew_pt = peewee.CharField(
        verbose_name="DEW PT. (Deg C)",  max_length=225)
    wet_bulb = peewee.CharField(
        verbose_name="WET BULB (Deg C)",  max_length=225)
    pressure = peewee.CharField(
        verbose_name="BARO. PRESS. (mb)",  max_length=225)
    snow = peewee.CharField(
        verbose_name="SNOW DEPTH (mm)",  max_length=225)
    precip = peewee.CharField(
        verbose_name="TOTAL PRECIP (mm)",  max_length=225)
